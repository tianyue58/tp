...
public class ParserUtilTest {
    ...
    public void parsePhone_validValueWithoutWhitespace_returnsPhone() throws Exception {
        Position expectedPhone = new Position(VALID_PHONE);
        assertEquals(expectedPhone, ParserUtil.parsePosition(VALID_PHONE));
    }
    ...
    public void parsePhone_validValueWithWhitespace_returnsTrimmedPhone() throws Exception {
        ...
        Position expectedPhone = new Position(VALID_PHONE);
        assertEquals(expectedPhone, ParserUtil.parsePosition(phoneWithWhitespace));
    }
    ...
    public void parseEmail_validValueWithoutWhitespace_returnsEmail() throws Exception {
        Deadline expectedEmail = new Deadline(VALID_EMAIL);
        assertEquals(expectedEmail, ParserUtil.parseDeadline(VALID_EMAIL));
    }
