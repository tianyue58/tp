...
public class TypicalApplications {
    ...
    public static final Application AMY = new ApplicationBuilder().withName(VALID_NAME_AMAZON)
            .withPosition(VALID_POSITION_AMAZON).withDeadline(VALID_DEADLINE_AMAZON)
            .withTags(VALID_TAG_REJECTED).build();
    public static final Application BOB = new ApplicationBuilder().withName(VALID_NAME_BYTEDANCE)
